...
INSERT INTO License (productId, name, organization, email, skype, phone, applicationArea)
VALUES (1, 'Mari Maasikas', 'Tuulepuumets', 'marii@kiisumets.ee', 'marii.kiisumets', '+372 555555', 'wood research');
