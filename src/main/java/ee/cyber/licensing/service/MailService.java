package ee.cyber.licensing.service;
...
public class MailService {
    ...
    public void generateAndSendMail(MailBody mailbody, int licenseId, int fileId) throws MessagingException, IOException, SQLException {
